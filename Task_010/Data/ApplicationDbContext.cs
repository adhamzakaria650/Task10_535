...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.;initial catalog= BikeStores535;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27BF664986");
        });

        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B434F40DA6");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85BD2FC5E1");
        });

        modelBuilder.Entity<Log>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__logs__9E2397E0A69D4FD4");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__465962290A72C26C");

            entity.ToTable("orders", "sales", tb => tb.HasTrigger("tt"));
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4187A1F2D");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5342C5572");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C8D5CB6C2");
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D38E817134");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C5DA3AFF3");
        });
